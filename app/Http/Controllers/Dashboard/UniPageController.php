...
{  
    ...
    public function store(Request $request) {
        $validated = $request->validate([
            ...
            "ratting" => ["required", "string", "max:255"],
        ...
        if (Arr::has($validated, "image")) {
            ...
            $image->move(public_path("uploads/university_page_log"), $imageName);
        }
        $imageName = null;
    ...
    public function update(Request $request, string $id) {
        ...
        if ($unipage) {
            ...
            $unipage->university_name = $validated["university_name"];
            $unipage->ratting = $validated["ratting"];   
            $unipage->review = $validated["review"]; 
            $unipage->slug = Str::slug($validated["slug"]);
            $unipage->content = $validated["content"];  
            $unipage->key_highlights = $validated["key_highlights"];                       
